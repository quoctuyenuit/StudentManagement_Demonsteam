...
namespace StudentManagements.DAL
{
    class ExportToExcel
    {
        ...
        public void Export_LookUpStudent(System.Data.DataTable table, string sheetName, string title)
        {
            ...
            // Trái cột họ tên và tên lớp

            Microsoft.Office.Interop.Excel.Range c3 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowStart, columnStart+1];

            Microsoft.Office.Interop.Excel.Range c4 = (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[rowEnd, columnStart + 2];
        ...
        public void Export_ClassInformation(System.Data.DataTable table, string ClassName, int ClassSize, string Year, string sheetName, string title)
        {
            ...
            Microsoft.Office.Interop.Excel.Range colClassName = oSheet.get_Range("A2", "C2");

            colClassName.MergeCells = true;

            colClassName.Value2 = "Tên Lớp:    " + ClassName;


            Microsoft.Office.Interop.Excel.Range colClassSize = oSheet.get_Range("D2", "F2");

            colClassSize.MergeCells = true;

            colClassSize.Value2 = "Sỉ Số:    " + ClassSize;

            Microsoft.Office.Interop.Excel.Range colYear = oSheet.get_Range("A3", "C3");

            colYear.MergeCells = true;

            colYear.Value2 = "Năm Học:    " + Year;
